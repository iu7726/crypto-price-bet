...
exports.missedThreeDay = void 0;
const missedThreeDay = () => {
            ...
            <tr>
              <td>
                <div style="text-align: center; margin:40px 0px;">
                  <img alt="" style="width:148px; height:129px; border-radius: 10px;" src="https://blogger.googleusercontent.com/img/a/AVvXsEgYGJnHBBWJ4x3Ove_UCmS8SmFN-DsQozQdivX--crvNmKhSx9lgEPp2AU7w4IJNFUZDOTUiSNc3Gh7ziWUibSJRwwp-ETjDgR8no5ibfn5LaoNJItDGaInbjlF_NbTA8QMdIWUNo6NxFaBH6DBruMrndD1gkW0jfYA9QogTveqMfDSwsgObg0yS1Rq"/>
                </div>
              </td>
            </tr>
                ...
                <div id="description" style="border-radius: 20px; color: #1A1B1C; font-family: Arial, Helvetica, sans-serif; font-size: 19px; font-weight: 400; line-height: 24px; margin: 0px; ">
                  <div>
                    ...
                    <div style="margin-top: 40px;">
                      ...
                      Okay, we’re overreacting. Come back and enter your predictions! We missed you!
...
exports.missedThreeDay = missedThreeDay;

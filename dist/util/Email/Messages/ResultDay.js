...
exports.resultDay = void 0;
const resultDay = (date) => {
              ...
              <tr>
                <td>
                  <div style="text-align: center; margin:40px 0px;">
                    <img alt="" style="width:504px; height:264px; border-radius: 10px;" src="https://blogger.googleusercontent.com/img/a/AVvXsEhDROvfnt9n7zLHIOusYyS1y7GGgToTIXRXF1Efl514-Z6EfIOL5ikxGr46bsiqoJzVw3OHu9FQf4cfo8VnRIp6WI4CXqdfvdOt8V2BSHf-ife049NX5WNlLvNLk62iEmeGyurtIi4PYpgBdM4ZfXNOoN7C1VeN891-4F5P5j8fQTduQKRW83B6f0Cv"/>
                  </div>
                </td>
              </tr>
                  ...
                  <div id="description" style="border-radius: 20px; color: #1A1B1C; font-family: Arial, Helvetica, sans-serif; font-size: 19px; font-weight: 400; line-height: 24px; margin: 0px; ">
                    <div>
                      ...
                      <div style="margin-top: 40px;">
                        ...
                        Head over to The Crypto Whisperer to view the results for your ${date} prediction.

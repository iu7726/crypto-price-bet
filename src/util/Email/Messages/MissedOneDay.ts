              ...
              <tr>
                <td>
                  <div style="text-align: center; margin:40px 0px;">
                    <img alt="" style="width:148px; height:148px; border-radius: 10px;" src="https://blogger.googleusercontent.com/img/a/AVvXsEiFttI9aK27jWqWBiD2_Hf-HGlCT6JfrLlXcsmwnvdZqF7FkTEbVPMmmTg2g3BLJZDNM08cB7q8ePxiH4_qF1Uiv_j0qkYlAmZwOYBSWVnc_Eq8SYSgBXzbM8M94n0bfsBKXBJVkh0Lcctfhc4aoMyJjU7qmiofGS7c3OkNqvuMgMfDyEX6nL2w9iuK"/>
                  </div>
                </td>
              </tr>
                  ...
                  <div id="description" style="border-radius: 20px; color: #1A1B1C; font-family: Arial, Helvetica, sans-serif; font-size: 19px; font-weight: 400; line-height: 24px; margin: 0px; ">
                    <div>
                      ...
                      <div style="margin-top: 40px;">
                        ...
                        No worries! Today’s another day. Visit The Crypto Whisperer to enter your next prediction.
